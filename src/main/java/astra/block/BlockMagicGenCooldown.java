...
public class BlockMagicGenCooldown extends BlockTransparent implements CustomBlock {
    ...
    public CustomBlockDefinition getDefinition() {
        return CustomBlockDefinition
                .builder(this, Materials
                        .builder()
                        .any(Materials.RenderMethod.BLEND, "stone_transparent") // set Block Render Method to be transparent and texture to "glass"
                )
